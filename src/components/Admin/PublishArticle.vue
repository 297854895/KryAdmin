<template>
  <div v-if="!view">
    ...
    <k-input width="960px" placeholder="请输入文章标题..." :onChange="saveTitle" :value="title" ></k-input>
    <div style="height: 20px;"></div>
  ...
  export default {
    data() {
      ...
      return {
        ...
        tagSelected: localData.tagSelected || {text: 'Html', key: 'Html'},
        tagSelect: [
         {text: 'Html', key: 'Html'},
    ...
    methods: {
      ...
      saveTitle(value) {
        this.savArticleAtLocal('title', value);
      ...
      tagSelectValue(cur) {
        this.savArticleAtLocal('tagSelected', cur);
        this.$data.tagSelected = cur;
      },
      daySelectValue(cur) {
